...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Cadastrar Agendamento</h2>
        </template>
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <form @submit.prevent="submit">
                            <div class="mb-4">
                                <label for="servico_id" class="block text-sm font-medium text-gray-700">Serviço</label>
                            ...
                            <div class="mb-4">
                                <label for="data_agendamento" class="block text-sm font-medium text-gray-700">Data de Agendamento</label>
